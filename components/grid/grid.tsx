...
function isResponsiveObject<T>(value: ResponsiveValue<T>): value is { sm?: T; md?: T; lg?: T } {
  return typeof value === "object" && value !== null && !Array.isArray(value)
}

function getBaseValue<T>(value: ResponsiveValue<T> | undefined, fallback: T): T {
...
export function Grid({
  ...
  const showHorizontalBorders = hideGuides !== "row" && hideGuides !== "all" && hideGuides !== true
  const showVerticalBorders = hideGuides !== "column" && hideGuides !== "all" && hideGuides !== true
  ...
  const gridStyle: React.CSSProperties = {
    ...
    borderTop: showHorizontalBorders ? `${guideWidth}px solid ${guideColor}` : undefined,
    borderLeft: showVerticalBorders ? `${guideWidth}px solid ${guideColor}` : undefined,
    ...cssVars,
    ...style,
