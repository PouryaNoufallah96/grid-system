...
function isResponsiveObject<T>(value: ResponsiveValue<T> | undefined): value is { sm?: T; md?: T; lg?: T } {
  return typeof value === "object" && value !== null && !Array.isArray(value)
}

function getBasePosition(value: ResponsiveValue<GridPosition> | undefined): string | undefined {
...
function getResponsivePositionVars(
  ...
  if (value.sm) vars[`--cell-${prefix}-sm`] = parseGridPosition(value.sm) || "auto"
  if (value.md) vars[`--cell-${prefix}-md`] = parseGridPosition(value.md) || "auto"
  if (value.lg) vars[`--cell-${prefix}-lg`] = parseGridPosition(value.lg) || "auto"

  return vars
}

export function GridCell({ children, column, row, solid = false, className, style }: GridCellProps) {
