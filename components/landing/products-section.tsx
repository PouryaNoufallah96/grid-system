  ...
  return (
    <section className="bg-black text-white">
      ...
      <div className="md:hidden px-6 py-12 space-y-10">
        ...
        <div className="space-y-6">
          {products.map((product) => (
            ...
            >
              ...
              <button className="mt-4 w-10 h-10 rounded-full border border-white/20 flex items-center justify-center">
        ...
        {/* Framework Infrastructure Banner */}
        <div className="text-center py-8 border-y border-white/10">
          <p className="text-xs text-gray-500 uppercase tracking-wider mb-3 flex items-center justify-center gap-2">
        ...
        <div className="text-center py-6">
          <p className="text-lg">
            <span className="font-semibold text-white">Scale your </span>
            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full border border-white/20 text-sm mx-1">
              Enterprise
            </span>
          ...
          <Container size="xl">
            <Grid columns={3} rows={4}>
              ...
              <GridCell column={3} row="1/3" className="p-8 flex flex-col">
                ...
                <p className="mt-3 text-gray-400 text-sm leading-relaxed">
                  Enrich any product or feature with the latest models and
                  tools.
                </p>
                <button className="mt-6 w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-black transition-colors">
                  <ArrowRight className="w-4 h-4" />
