      ...
      <div className="md:hidden px-6 py-12 space-y-10">
          ...
          <ul className="mt-6 space-y-3">
            <li className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <span>
                ...
                <span className="text-white font-medium">from git</span> or with{" "}
            ...
            <li className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <span>
                <span className="text-white font-medium">Wide range</span>{" "}
            ...
            <li className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <span>
                <span className="text-white font-medium">Previews</span> for
                every push
              </span>
            </li>
            <li className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <span>
                <span className="text-white font-medium">Automatic HTTPS</span>{" "}
        ...
        <div className="grid grid-cols-2 gap-4">
          {templates.map((template) => (
            <div
              key={template.name}
              className="rounded-lg bg-zinc-900/50 border border-white/10 p-4"
            >
              <div
                className={`w-12 h-12 rounded-xl ${template.bgClass} flex items-center justify-center ${template.textColor} font-bold text-xl mb-3`}
              >
                {template.icon === "react" ? (
                  <svg
                    viewBox="0 0 24 24"
        ...
        <div className="space-y-3">
          <div className="w-full rounded-full border border-white/20 p-4 flex items-center justify-between">
          ...
          <Button
            variant="outline"
            className="w-full rounded-full bg-zinc-900 border-white/10 text-white px-6 py-4"
          >
            Talk to an Expert
          ...
          <Container size="xl">
            <Grid columns={3} rows={5}>
              ...
              <GridCell column={1} row="1/5" solid className="p-8 bg-black">
                ...
                <ul className="mt-8 space-y-4">
                  <li className="flex items-start gap-3 text-sm text-gray-400">
                    ...
                    <span>
                      Deploy automatically{" "}
                      <span className="text-white font-medium">from git</span>{" "}
                      or with{" "}
                      <span className="text-white font-medium">our CLI</span>
                    </span>
                  </li>
                  ...
                  <li className="flex items-start gap-3 text-sm text-gray-400">
                    <Eye className="w-5 h-5 shrink-0 mt-0.5" />
                    <span>
                      <span className="text-white font-medium">Previews</span>{" "}
                      for every push
                    </span>
                  </li>
                  <li className="flex items-start gap-3 text-sm text-gray-400">
              ...
              <GridCell
                column={3}
                row={4}
                className="p-4 flex flex-col gap-3 justify-center"
              >
                <Button
                  variant="outline"
