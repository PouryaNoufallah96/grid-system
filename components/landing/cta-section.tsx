  ...
  return (
    <section className="bg-black text-white">
      ...
      <div className="md:hidden px-6 py-12">
        <p className="text-xl font-bold tracking-tight leading-tight text-balance">
        ...
        <div className="mt-6 flex flex-col gap-3">
          <Button className="rounded-full bg-white text-black hover:bg-gray-100 px-6 w-full">
            Start Deploying
          </Button>
          <Button
            variant="outline"
            className="rounded-full border-white/20 text-white hover:bg-white/10 bg-transparent px-6 w-full"
          >
            Talk to an Expert
          </Button>
        </div>
        ...
        <p className="mt-8 text-sm text-gray-400 leading-relaxed">
          Take a look around the entire platform, from start to finish. Find out
          how we can improve your developer experience.
        </p>

        <button className="mt-4 inline-flex items-center gap-2 text-white font-medium">
          Tour the Product
            ...
            <Grid columns={3} rows={1}>
              ...
              <GridCell column="1/3" row={1} solid className="p-8 bg-black">
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                  <Button className="rounded-full bg-white text-black hover:bg-gray-100 px-6">
                    Start Deploying
                  </Button>
                  <Button
                    variant="outline"
              ...
              <GridCell column={3} row={1} className="p-8">
                <p className="text-sm text-gray-400 leading-relaxed">
                  Take a look around the entire platform, from start to finish.
                  Find out how we can improve your developer experience.
                </p>
